...
public class TruckingPipeline {
  private static final Logger LOG =
      LoggerFactory.getLogger(TruckingPipeline.class);
  ...
  public static void main(String[] args) {
    ...
    if (running_in_cloud) {
      ...
      lines =
          p.apply(TextIO.Read.from(filePath + "/logs/package_log_1.txt"));
    } else {
    ...
    /* REMOVE THIS LINE TO COMPLETE BASIC CODELAB
